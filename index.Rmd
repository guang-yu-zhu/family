...
<img style="border-radius: 50%;" src="figures/avatar.jpg" width="150px"/>
...
.pull-left-narrow[
```{r,out.width='100%'}
knitr::include_graphics('figures/jiang.jpg')
```
]
...
.pull-left-narrow[
```{r,out.width='100%'}
knitr::include_graphics('figures/qin.jpg')
```
]
...
.pull-right[
```{r,out.width='100%'}
knitr::include_graphics('figures/tingting.jpg')
```
]
] <!---->
...
.pull-right[
```{r,out.width='100%'}
knitr::include_graphics('figures/lucy.jpg')
```
]
] <!---->
] <!--end of panelset-->
